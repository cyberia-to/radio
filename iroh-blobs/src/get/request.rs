...
use cyber_bao::{io::BaoContentItem, ChunkNum, ChunkRanges};
use bytes::Bytes;
...
impl fmt::Debug for GetBlobResult {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.debug_struct("GetBlobResult").finish()
    }
}
...
pub async fn get_chunk_probe(
    ...
    let ranges = ChunkRanges::from(chunk..chunk + 1u64);
