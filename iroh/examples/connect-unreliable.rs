//! The smallest example showing how to use iroh and [`radio::Endpoint`] to connect to a remote endpoint and pass bytes using unreliable datagrams.
//!
...
use clap::Parser;
use radio::{Endpoint, EndpointAddr, RelayMode, RelayUrl, SecretKey};
