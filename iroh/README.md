...
`radio::files` adds [file streams through injected storage](../specs/file-stream.md)
to the existing router. Hosts authorize each requested file and supply its source
and sink capabilities; Cybergraph's adapter performs durable writes through BBG.
